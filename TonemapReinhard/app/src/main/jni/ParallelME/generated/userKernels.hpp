...
const char userKernels[] =
    ...
    "    if(fabs(pixel1.s3) < FLT_EPSILON)            \n"
    "        pixel1.s3 = log(0.00001f + pixel1.s0);   \n"
    "    if(fabs(pixel2.s3) < FLT_EPSILON)            \n"
    ...
    "}                                                    \n"
    "                                                     \n"
    "__kernel void reduce2_tile(__global float4* PM_data, \n"
    "        __global float4* PM_tile, int PM_width) {    \n"
    "    int PM_gid = get_global_id(0);                   \n"
    ...
    "}                                                    \n"
    "                                                     \n"
    "__kernel void reduce2(__global float4* PM_tile,      \n"
    "        __global float4* PM_red, int PM_height) {    \n"
